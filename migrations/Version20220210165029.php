 ...
 */
final class Version20220210165029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipo ADD liga_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipo ADD CONSTRAINT FK_C49C530BCF098064 FOREIGN KEY (liga_id) REFERENCES liga (id)');
        $this->addSql('CREATE INDEX IDX_C49C530BCF098064 ON equipo (liga_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C49C530BCF098064 ON equipo');
        $this->addSql('ALTER TABLE equipo DROP liga_id, CHANGE nombre nombre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE socios socios VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE ciudad ciudad VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
